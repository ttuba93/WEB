...
export const products = [
  ...
  },
  {
    ...
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/hef/h76/51387499577374/lejiada-yg300-105219862-1.jpg',
    price: 21949,
  ...
  },
  {
    ...
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h7b/hfd/31544039800862/fender-squier-sa-150-dreadnought-natural-14100005-1-Container.jpg',
    price: 59900,
    description:
      'Гитара отлично подходит для ежедневных интенсивных занятий. Новая модель обладает ламинированной конструкции с верхней декой из липы и красного дерева на нижней деке и обечайках.',
    rating: '5/5',
  ...
  },
  {
    ...
    image:
      'https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h0d/h2e/31513526272030/hasbro-monopolia-klassiceskaa-obnovlennaa-c1009-10100767-1-Container.jpg',
    price: 22995,
    description:
      'Настольная игра «Классическая монополия» от производителя Hasbro поможет собрать всех членов семьи. Ее суть заключается в том, чтобы приобретать собственность, вкладывать деньги в недвижимость и заключении сделок с партнерами.',
    rating: '5/5',
